...
//SERVIDOR DE NUMEROS QUE DA NUMEROS PARA CADA CLIENTE - Timestemp

main()
{
	int sock, length, count = 0;
...
do
{
  ...
  sendto(sock, (char *)&count, sizeof count, 0, (struct sockaddr *)&name, sizeof name);//é preciso fazer um cast para CHAR
